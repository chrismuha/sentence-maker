...
## Keyboard shortcut
- Use **Settings** and press a key to assign a shortcut for **Break** (single letters/numbers or symbols alone are blocked; pressing two together—including symbol + letter or space/backspace combos are allowed; Shift+Shift is blocked; Alt/Cmd is allowed with another key).
